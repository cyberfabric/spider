...
**Pattern**: Global `SpaiderContext` loaded at CLI startup, providing access to adapter, weavers, and registry.

**Implementation**: [context.py](skills/spaider/scripts/spaider/utils/context.py)
...
**Implementation**: [template.py](skills/spaider/scripts/spaider/utils/template.py)

### 6. Spaider ID Pattern
...
**Implementation**: [parsing.py](skills/spaider/scripts/spaider/utils/parsing.py)
