"""
Spaider Validator - Constants and Regex Patterns

All regular expressions and global constants used throughout the Spaider validation system.
...
PROJECT_CONFIG_FILENAME = ".spaider-config.json"
